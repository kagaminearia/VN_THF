label q1_1:
    ...
    #TODO: 后接转场切换场景
    stf_speaking "这是临时的住所和工作信息，时限一周，到期后如工作不通过，管制局不再提供任何帮助。"
    qian_speaking "好的……其它问题呢？\n我家里的情况，还有我家里人……"
    qian_speaking "我顿了顿，仍然不死心地继续说道。"
    stf_speaking "D层身份信息的准备已经完成，如果没有其他需求，请及时结束咨询。"
    ...
    qian_speaking "啊……抱歉。\n你们是在这里排队吗？里面没什么人的，在里面等更好。不用在外面……这样，看起来不太好吧。"
    ...
    thin_speaking "真是不懂事，哎，哪有你这样说话的？跑别人面前嫌弃别人，要是换一个人啊你怕是要吃点教训哦。\n知道D层的管理费多少钱吗？这些家伙害得大家都不敢多开灯，就他们这地方最亮，待在这怎么了？"
    thin_speaking "看你这样子也是不懂，呵呵，D层这么乱，他们完全不管的。他们能有一万种办法从你手里掏钱，不光掏钱还受苦，好好珍惜还不用担心这些事的时候吧。"
    qian_speaking "不是，我没……\n呃，抱歉\n那个我走了再见拜拜"
