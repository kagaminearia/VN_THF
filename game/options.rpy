...
define config.name = _("Dust On Thorn")
...
define config.main_menu_music = "audio/bgm/theme.mp3"
...
define config.window_show_transition = Dissolve(0.05)
define config.window_hide_transition = Dissolve(0.05)
...
define config.save_directory = "thorn_test-1684901032"
